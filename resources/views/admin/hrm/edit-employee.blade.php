@extends('master')
@section('title','Edit Employee | ATS Technology')
@section('main-body')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><i class="fa fa-edit"></i> Edit Employee</h4>
            ...
            <form action="{{ route('editEmployee', $employee->id) }}" method="post">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="mobile_no" value="{{ $employee->mobile_no }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="permanent_address" value="{{ $employee->permanent_address }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label class="form-label">Present Address</label>
                                        <input type="text" class="form-control" name="present_address" value="{{ $employee->present_address }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="joining_date" value="{{ $employee->joining_date }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-2">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="current_balance" value="{{ $employee->current_balance }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 mb-4">
                    <div class="text-end">
                        <button type="submit" class="btn btn-success"><i class="fa fa-refresh me-1"></i>Update Employee</button>
                    </div>
                </div>
            </form>
        </div>
