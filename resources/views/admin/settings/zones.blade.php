@extends('master')
@section('title','Zones | ATS Technology')
@section('main-body')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><i class="fa fa-store"></i> Zones</h4>
            ...
            <div class="col-lg-12">
                <div class="d-flex flex-wrap justify-content-end gap-2 mb-3">
                    <a href="#" id="add-new-zone" data-bs-toggle="modal" data-bs-target="#addEditZoneModal"><button type="button" class="btn btn-success"><i class="fa fa-plus me-1"></i> Add New Zone</button></a>
                </div>
...
<div class="modal fade zoomIn" id="addEditZoneModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="text" name="zone_name" class="form-control" id="zone_name" required />
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#add-new-zone').click(function(){  
        $('#submit-btn').html("Add");  
        $('#add_edit_zone_form')[0].reset();
        $('#modalHeader').html("Add New Zone"); 
        $('#id').val(""); 
    }); 
    
    $('#add_edit_zone_form').on("submit", function(event){ 
        event.preventDefault();  
        $.ajax({  
            url:"{{ route('addEditZone') }}",  
            method:"POST",  
            data:$('#add_edit_zone_form').serialize(),  
            beforeSend:function(){  
                $('#submit-btn').html("Updating");  
            },  
            success:function(data){  
                $('#add_edit_zone_form')[0].reset();  
                $('#addEditZoneModal').modal('hide');  
