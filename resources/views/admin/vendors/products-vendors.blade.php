@extends('master')
@section('title','Vendors | ATS Technology')
@section('main-body')
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0"><i class="fa fa-industry"></i> Vendors</h4>
            ...
            <div class="col-lg-12">
                <div class="d-flex flex-wrap justify-content-end gap-2 mb-3">
                    <a href="#" id="add-new-vendor" data-bs-toggle="modal" data-bs-target="#addEditVendorModal"><button type="button" class="btn btn-success"><i class="fa fa-plus me-1"></i> Add New Vendor</button></a>
                </div>
...
<div class="modal fade zoomIn" id="addEditVendorModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            <div class="modal-header p-3 bg-soft-info">
                <h5 class="modal-title" id="modalHeader">Add New Vendor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
            <form id="add_edit_vendor_form">
    ...
    $(document).on('click', '.edit_vendor', function(){
        ...
        $.ajax({  
            ...
            success:function(data){ 
                ...
                $('#modalHeader').html("Edit Vendor");
                $('#edit-btn').html("Update"); 
                $('#addEditVendorModal').modal("show");  
            }  
        });  
    }); 
    
    $('#add_edit_vendor_form').on("submit", function(event){  
        event.preventDefault();  
        $.ajax({  
            url:"{{ route('addEditProductsVendor') }}",  
            method:"POST",  
            data:$('#add_edit_vendor_form').serialize(),  
            beforeSend:function(){  
