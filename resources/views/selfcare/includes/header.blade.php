                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user border" src="{{ Auth::guard('reseller')->user()->profile_picture == null ? asset('images/avatar.png') : asset('images/profile_pictures').'/'.Auth::guard('reseller')->user()->profile_picture }}" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::guard('reseller')->user()->name }}</span>
                            </span>
                        </span>
                    </button>
